...
1. **Connexion acceptée :** Remerciement spontané + partage d'une ressource gratuite de haute valeur, sans formulaire (*Value First*).
2. **Suivi opportun (J+3) :** Question ouverte ciblée portant sur le principal point de douleur opérationnel de son secteur.
3. **Approfondissement (J+7) :** Invitation exclusive à un cas client similaire ou une étude de cas résolvant ce problème précis.
